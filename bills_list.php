                            ...
                            while ($row = mysqli_fetch_array($select_all_bills_exec)) {
                                ...
                                if ($row['buyer_id'] != '0') {
                                    echo "<td style='background-color:green'>" . "مباعة" . "</td><td>
                                        <a href='com_bill.php?id=" . $row['id'] . "'><button type='button' class='btn btn-success'>عرض الفاتورة</button></a>
                                        </td>";
                                } else {
                                    echo "<td style='background-color:red'>" . "غير مباعة" . "</td><td>
                                        <a href='com_bill.php?id=" . $row['id'] . "'><button type='button' class='btn btn-primary'>بيع الفاتورة</button></a>
                                        </td>";
                                }
                                echo "</tr>";
                            }
